...
Description : This script reads chain seperated dssp files and extracts the torsion angles, calculates the RMSDA and assigns PBs.Output is written to PDB_chainID.dssp.pb files.

Usage : example- perl dssp_to_pb.pl path/input_file path/output_directory.
